  ...
  return (
    <section className="py-24 bg-background">
      <div className="container mx-auto px-6">
        <div className="rounded-3xl bg-primary text-primary-foreground p-12 md:p-20 relative overflow-hidden text-center md:text-left">
          {/* Abstract Pattern */}
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="max-w-2xl">
              ...
              <p className="text-primary-foreground/80 text-lg md:text-xl mb-0 max-w-xl">
